...
<head>
    ...
    <title>My Profile - Food Plaza</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="profile-card">
                        ...
                        <div class="password-section mt-5">
                            ...
                            <form method="POST" action="">
                                ...
                                <button type="submit" class="btn btn-foodplaza w-100" name="update_password">Update Password</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    Swal.fire({
        ...
        customClass: {
            confirmButton: 'btn btn-foodplaza',
        }
    });
</script>
