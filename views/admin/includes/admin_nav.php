...
<nav class="col-md-3 col-lg-2 d-md-block admin-sidebar sidebar p-0">
    <div class="position-sticky d-flex flex-column align-items-center py-4 h-100">
        <a class="navbar-brand mb-4 admin-brand" style="color: #fff !important;" href="../../index.php">
            Food Plaza <i class="fa-solid fa-seedling ms-1"></i>
        </a>
