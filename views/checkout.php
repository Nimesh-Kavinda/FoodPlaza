...
<head>
  ...
  <title>Checkout - Food Plaza</title>
  <!-- Bootstrap 5 CSS -->
...
<section class="checkout-hero-section py-5">
  <div class="container">
    ...
    <div class="row g-4 align-items-start">
      <!-- Checkout Form -->
      <div class="col-lg-7">
        <div class="card shadow-sm border-0 p-4 checkout-form-card">          <h4 class="mb-3" style="color: var(--foodplaza-primary);">Delivery Details</h4>
          ...
          <form method="post" action="">            <div class="mb-3">
            ...
            <button class="btn btn-foodplaza w-100 py-2 fs-5 mt-2" type="submit" <?php echo empty($cart_items) ? 'disabled' : ''; ?>>
                Place Order
            </button>
        ...
        <div class="cart-summary card shadow-sm border-0 p-4 sticky-top" style="top: 100px;">
          ...
          <?php if (empty($cart_items)): ?>
            <div class="text-center py-4">
              ...
              <a href="shop.php" class="btn btn-foodplaza mt-3">Order More Food</a>
            </div>
          <?php else: ?>
            <div class="mb-3">
